...
namespace Tekliftakip.Controllers
{
    public class StocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StockId,StockCode,StockAmount")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StockId,StockCode,StockAmount")] Stock stock)
        {
            if (id != stock.StockId)
            {
                return NotFound();
